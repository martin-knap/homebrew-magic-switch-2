cask "magicswitch2" do
  ...
  url "https://github.com/martin-knap/homebrew-magic-switch2/releases/download/v#{version}/MagicSwitch2.app.zip"
  name "MagicSwitch2"
  desc "One-click Magic Keyboard and Trackpad switching between Macs"
  homepage "https://github.com/martin-knap/homebrew-magic-switch2"
